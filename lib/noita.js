    ...
    loadOutcomes() {
        ...
        for (const file of files) {
            ...
            if (typeof this.settings[name] == "undefined") {
                this.parent.settings.setKey("outcomes", name, {
                    id: name,
                    name: name,
                    enabled: false,
                    comment: "What does this do ?",
                    description: "Description below name in game",
                    type: "unknown",
                    rarity: 50
                })
            }
...
class Noita {
    ...
    getWinner() {
        ...
        return {
            func: `twitch_${this.choices[0].id}()`,
            name: this.choices[0].name,
            desc: this.choices[0].description
        }
    }
